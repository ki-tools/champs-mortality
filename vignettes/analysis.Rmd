...
```{r}
params <- I("Site,Catchment,Age,Condition,UC_or_CC,DSS
S6,C1,Stillbirth,Perinatal asphyxia/hypoxia,UC,Yes
S6,C1,Stillbirth,Congenital birth defects,UC,Yes
S6,C1,Stillbirth,Other neonatal disorders,UC,Yes
")
