...
DSS is a dataset available as a downloadable file from LabKey.
...
This dataset, although it does not contain individual-level data, is not shared publicly and is available as a downloadable file from LabKey.
