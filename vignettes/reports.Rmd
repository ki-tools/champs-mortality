...
We can plot crude and adjusted rates (`type = "rate"`) and fractions (`type = "frac"`) along with their credible intervals for our set of results with the following:

```{r}
plot_rates_fracs(graf, type = "rate", plotly = FALSE)
plot_rates_fracs(graf, type = "frac", plotly = FALSE)
```
